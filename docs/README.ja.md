...
- [x] **ナビゲーションバーのカスタマイズ** - ロゴ、タイトル、リンク、static/fixed/dynamic モードをカスタマイズ
- [x] **壁紙モード切り替え** - バナー、フルスクリーン（classic/hero）、透明フルスクリーン、単色背景
- [x] **レスポンシブ動画壁紙** - デスクトップ/モバイル別の動画ソースと主体位置をサポート
